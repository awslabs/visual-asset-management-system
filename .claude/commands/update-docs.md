...
-   `backend/backend/handlers/osVectorSearch/`, `backend/backend/common/vectorsearch/`, `infra/lib/nestedStacks/searchAndIndexing/` (vector indexing construct) → `docs/concepts/vector-search.md`, `docs/api/search.md`, `docs/architecture/details.md` (indexing flow)
