...
-   Python 3.12+, Docker (or a Docker-compatible CLI such as [Finch](https://aws.github.io/finch/) or [Podman](https://podman.io/)), Node.js 22+, npm 11.0.0+, AWS CLI, AWS CDK CLI
