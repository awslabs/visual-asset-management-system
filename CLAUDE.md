...
| Configuration system (new config field, feature switch, changed default) | `infra/CLAUDE.md`, `documentation/docusaurus-site/docs/deployment/configuration-reference.md`, and the **ConfigBuilder** component (`documentation/docusaurus-site/src/components/ConfigBuilder/`) — then run the `infra/test/configBuilderSync.test.ts` drift check                                                                                                                                           |
...
7. Mirror the new config option into the **ConfigBuilder** component (`documentation/docusaurus-site/src/components/ConfigBuilder/` — see its `README.md` for which files to touch: `schema.ts`, `defaults.ts`, `validation.ts`), then confirm `infra/test/configBuilderSync.test.ts` passes
