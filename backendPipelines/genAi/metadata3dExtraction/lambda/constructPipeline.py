...
logger = safeLogger(service="ConstructPipelineGenAiMetadataExtraction")
...
def lambda_handler(event, context):
    ...
    definition = construct_metadataExtraction_definition(event)
...
def construct_metadataExtraction_definition(event) -> dict:
