"""
Cosmos Transfer 2.5 Model Manager

Simplified model management for Transfer 2.5 which uses HuggingFace's native HF_HOME
cache mechanism. Models are automatically downloaded by the inference script
on first run.
...
The key difference from v1: no explicit model download step is needed.
Cosmos Transfer 2.5 handles model downloads internally via HF_HOME.
"""
...
# S3 prefix for HF cache backups
S3_HF_CACHE_PREFIX = "cosmos-transfer2.5/hf_cache"
