...
def build_job_name(control_type, orchestration_event_prefix):
    ...
    runs of the same control type and Step Functions rejects a repeated name with
    ...
    """
    prefix = f"cosmos-transfer-{control_type}-"
    pipeline_execution_id = manifestHelper.pipeline_execution_id_from_event_prefix(
        orchestration_event_prefix)
...
def lambda_handler(event, context):
    ...
    job_name = build_job_name(control_type, orchestration_event_prefix)
