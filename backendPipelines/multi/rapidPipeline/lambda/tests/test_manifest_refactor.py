...
for k, v in {
    ...
    "CONTAINER_LOG_GROUP_NAME": "/aws/vendedlogs/Pipelines/rapidpipeline-x",
    "CONTAINER_LOG_GROUP_ARN":
        "arn:aws:logs:us-east-1:123456789012:log-group:/aws/vendedlogs/Pipelines/rapidpipeline-x:*",
}.items():
...
class TestOpenPipeline:
    ...
    def test_registers_the_container_log_group_it_owns_for_the_run_task_stage(self):
        ...
        assert detail["subExecution"]["label"] == "RapidPipeline processing"
        sfn_log, container_log = detail["logs"]
        assert sfn_log["sourceType"] == "stateMachine"
        assert sfn_log["label"] == "RapidPipeline state machine"
        assert container_log == {
            "logGroupArn": "arn:aws:logs:us-east-1:123456789012:log-group:/aws/vendedlogs/Pipelines/rapidpipeline-x:*",
            "logGroupName": "/aws/vendedlogs/Pipelines/rapidpipeline-x",
            "logStreamName": "",
            "logStreamPrefix": "ecs/",
            "stageName": "RapidPipelineRunFargate",
            "sourceType": "container",
            "label": "RapidPipelineRunFargate container",
        }
