...
-   _CLI_ Old CLI documentation pages deprecated in favor of the main documentation. Installation, authenticaiton, and development pages left for now in `/tools/vamscli/docs` but commands and troubleshooting pages are migrated to `documentation\docusaurus-site\docs\cli\*`.
