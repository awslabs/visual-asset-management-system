...
-   **Pipeline** The GenAI metadata pipeline publishes its embedding event when the resolved manifest carries no asset bucket id; the vector indexer resolves the file's bucket from the asset row.
