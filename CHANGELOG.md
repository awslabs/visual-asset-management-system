...
-   **CDK** The trigger dispatcher skips triggers whose workflow is archived or disabled; archiving a workflow deletes its trigger rows; the registration custom resource's `Delete` path deletes triggers before archiving.
