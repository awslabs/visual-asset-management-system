...
| ----------------------------------------- | ----------------------- | ---------------- | -------------------------------------------------------------- |
| CloudFormation resources per template     | 500, not adjustable     | Per nested stack | `apiBuilder` 108, `apiBuilder2` 110                            |
| CloudFormation template body in Amazon S3 | 1 MB, not adjustable    | Per nested stack | `apiBuilder` ~0.49 MB, `apiBuilder2` ~0.48 MB                  |
