...
const withEks = (eksClusterVersion: unknown) =>
    loadConfig((c) => {
        ...
        // Required once the pipeline is enabled: getConfig() rejects the shipped placeholder
        // image URI, which is the point of S1-INFRA-099. A harness that switches a pipeline on
        // has to configure it validly.
