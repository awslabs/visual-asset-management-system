...
} from "../../lib/lambdaBuilder/osVectorSearchFunctions";
...
/** The Lambda resource whose handler is `handlers.osVectorSearch.<module>.lambda_handler`. */
...
describe("vector-search Lambda builders", () => {
    ...
    test("each builder names a handler module under handlers/osVectorSearch", () => {
