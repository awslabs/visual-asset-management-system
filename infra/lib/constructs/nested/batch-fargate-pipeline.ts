...
export class BatchFargatePipelineConstruct extends Construct {
  ...
  constructor(parent: Construct, name: string, props: BatchFargatePipelineConstructProps) {
    ...
    this.batchJobDefinition = new batch.JobDefinition(
      this,
      "PipelineBatchJobDefinition",
      {
    ...
    const containerProps = cfnJobDef.containerProperties as CfnJobDefinition.ContainerPropertiesProperty;
