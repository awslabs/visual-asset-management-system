...
export function buildVamsExecuteModelOpsFunction(
    ...
    const name = "vamsExecuteModelOps";
    const fun = new lambda.Function(scope, name, {
        code: lambda.Code.fromAsset(
            path.join(__dirname, `../../../../../../../backendPipelines/multi/modelOps/lambda`)
        ),
...
export function buildConstructPipelineFunction(
    ...
    // Giving Lambda function permission to upload ModelOps config file to auxiliary bucket
    fun.addToRolePolicy(
