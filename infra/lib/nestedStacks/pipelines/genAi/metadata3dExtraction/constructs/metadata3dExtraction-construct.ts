...
import {
    ...
    buildVamsExecuteMetadata3dExtractionPipelineFunction,
    buildMetadataGenerationPipelineFunction,
    buildPipelineEndFunction,
} from "../lambdaBuilder/metadata3dExtractionFunctions";
...
export interface Metadata3dExtractionConstructProps extends cdk.StackProps {
 ...
 */
const defaultProps: Partial<Metadata3dExtractionConstructProps> = {
    //stackName: "",
    //env: {},
};
...
export class Metadata3dExtractionConstruct extends NestedStack {
    constructor(parent: Construct, name: string, props: Metadata3dExtractionConstructProps) {
        ...
        const lambdaMetadata3DExtractionLayer = new lambda.LayerVersion(
            this,
            "VAMSMetadata3dExtractionLayer",
            {
                layerVersionName: "vams_layer_genaimetadataextraction",
                code: lambda.Code.fromAsset(
                    "../backendPipelines/genAi/metadata3dExtraction/lambdaLayer",
                    {
                        bundling: {
        ...
        const containerExecutionRole = new iam.Role(
            this,
            "Metadata3dExtractionContainerExecutionRole",
            {
        ...
        const containerJobRole = new iam.Role(this, "Metadata3dExtractionContainerJobRole", {
            assumedBy: Service("ECS_TASKS").Principal,
            inlinePolicies: {
                InputBucketPolicy: inputBucketPolicy,
                OutputBucketPolicy: outputBucketPolicy,
        ...
        const blenderRendererBatchPipeline = new BatchFargatePipelineConstruct(
            ...
            "BatchFargatePipeline_BlenderRenderer",
            {
                ...
                imageAssetPath: path.join(
                    ...
                    "backendPipelines",
                    "genAi",
                    "metadata3dExtraction",
                    "container"
                ),
                dockerfileName: "Dockerfile_BlenderRenderer",
                batchJobDefinitionName: "MetaData3dExtractionJob_BlenderRenderer",
            }
        );
        ...
        const metadataGenerationPipelineFunction = buildMetadataGenerationPipelineFunction(
            this,
            props.lambdaCommonBaseLayer,
            lambdaMetadata3DExtractionLayer,
        ...
        const stateMachineLogGroup = new logs.LogGroup(
            this,
            "Metadata3dExtractionProcessing-StateMachineLogGroup",
            {
                logGroupName:
                    "/aws/vendedlogs/VAMSStateMachine-MetaData3dExtractionPipeline" +
        ...
        const pipelineStateMachine = new sfn.StateMachine(
            this,
            "Metadata3dExtractionProcessing-StateMachine",
            {
        ...
        const metadata3dExtractionPipelineExecuteFunction =
            buildVamsExecuteMetadata3dExtractionPipelineFunction(
                this,
                props.lambdaCommonBaseLayer,
                props.storageResources.s3.assetBucket,
        ...
        new CfnOutput(this, "Metadata3dExtractionLambdaExecutionFunctionName", {
            value: metadata3dExtractionPipelineExecuteFunction.functionName,
            description:
            ...
            [
                {
                    ...
                    appliesTo: [
                        {
                            // https://github.com/cdklabs/cdk-nag#suppressing-a-rule
                            regex: "^Resource::.*Metadata3dExtractionProcessing-StateMachine/Role/.*/g",
                        },
                    ],
                },
            ],
            ...
            [
                {
                    ...
                    appliesTo: [
                        {
                            // https://github.com/cdklabs/cdk-nag#suppressing-a-rule
                            regex: "^Resource::.*vamsExecuteGenAiMetadata3dExtractionPipeline/ServiceRole/.*/g",
                        },
                    ],
                },
            ],
        ...
        NagSuppressions.addResourceSuppressionsByPath(
            Stack.of(this),
            `/${this.toString()}/Metadata3dExtractionProcessing-StateMachine/Role/DefaultPolicy/Resource`,
            [
                {
                    id: "AwsSolutions-IAM5",
        ...
        NagSuppressions.addResourceSuppressionsByPath(
            Stack.of(this),
            `/${this.toString()}/vamsExecuteGenAiMetadata3dExtractionPipeline/ServiceRole/DefaultPolicy/Resource`,
            [
                {
                    id: "AwsSolutions-IAM4",
                    reason: "vamsExecuteGenAiMetadata3dExtractionPipeline requires AWS Managed Policies, AWSLambdaBasicExecutionRole and AWSLambdaVPCAccessExecutionRole",
                    appliesTo: [
                        "Policy::arn:<AWS::Partition>:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole",
                        "Policy::arn:<AWS::Partition>:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole",
                    ],
                ...
                {
                    id: "AwsSolutions-IAM5",
                    reason: "vamsExecuteGenAiMetadata3dExtractionPipeline uses default policy that contains wildcard",
                    appliesTo: ["Resource::*"],
                },
                {
                    id: "AwsSolutions-IAM5",
