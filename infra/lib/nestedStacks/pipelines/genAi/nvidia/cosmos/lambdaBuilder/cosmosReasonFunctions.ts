...
export function buildVamsExecuteCosmosReasonPipelineFunction(
    scope: Construct,
    ...
    const name = "vamsExecuteCosmosReasonPipeline";
    const constructId = modelKey ? `${name}-${modelKey}` : name;
    const fun = new lambda.Function(scope, constructId, {
        code: lambda.Code.fromAsset(
            path.join(
                __dirname,
                `../../../../../../../../backendPipelines/genAi/nvidia/cosmos/reason/lambda`
            )
        ),
...
export function buildConstructReasonPipelineFunction(
    scope: Construct,
    lambdaCommonBaseLayer: LayerVersion,
    config: Config.Config,
    vpc: ec2.IVpc,
...
export function buildOpenReasonPipelineFunction(
    scope: Construct,
    lambdaCommonBaseLayer: LayerVersion,
...
export function buildReasonPipelineEndFunction(
    scope: Construct,
    lambdaCommonBaseLayer: LayerVersion,
    assetAuxiliaryBucket: s3.IBucket,
    config: Config.Config,
