...
export function buildVamsExecuteTrimeshConversionPipelineFunction(
    scope: Construct,
    ...
    const name = "vamsExecuteTrimeshConversion" 


    const fun = new lambda.DockerImageFunction(scope, name, {
        code: lambda.DockerImageCode.fromImageAsset(path.join(__dirname, '../../../../../../../backendPipelines/conversion/trimesh/lambdaContainer')),
