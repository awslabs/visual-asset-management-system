...
export class DynamoDbComplianceSchemaDefaultsConstruct extends Construct {
    constructor(
        ...
        if (!props.config.app.compliance.autoLoadDefaultSchema) {
            return;
        }
        ...
        const awsSdkCall: AwsSdkCall = {
            ...
            action: "putItem",
            parameters: {
                TableName: props.storageResources.dynamo.complianceSchemaStorageTable.tableName,
                Item: {
            ...
            physicalResourceId: PhysicalResourceId.of(
                props.storageResources.dynamo.complianceSchemaStorageTable.tableName +
            ...
            [
                {
                    ...
                    reason: "Custom resource role requires DynamoDB PutItem permissions for Compliance default schema initialization. Scoped to the specific Compliance schema table.",
                },
            ],
            true
        );
