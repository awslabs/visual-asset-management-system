...
export class VisualizationPipelineConstruct extends NestedStack {
    constructor(parent: Construct, name: string, props: VisualizationPipelineConstructProps) {
        ...
        const outputBucketPolicy = new iam.PolicyDocument({
            statements: [
                new iam.PolicyStatement({
                    actions: ["s3:GetObject", "s3:PutObject", "s3:DeleteObject"],
                    resources: [
                        props.storageResources.s3.assetVisualizerBucket.bucketArn,
                        `${props.storageResources.s3.assetVisualizerBucket.bucketArn}/*`,
                    ],
                }),
                new iam.PolicyStatement({
                    actions: ["s3:ListBucket"],
                    resources: [props.storageResources.s3.assetVisualizerBucket.bucketArn],
                }),
            ],
        });
        ...
        const pipelineEndFunction = buildPipelineEndFunction(
            ...
            props.storageResources.s3.assetVisualizerBucket,
            props.config,
            props.vpc,
            props.visualizerPipelineSubnets,
            props.visualizerPipelineSecurityGroups,
        ...
        const visualizerPCPipelineExecuteFunction = buildExecuteVisualizerPCPipelineFunction(
            ...
            props.storageResources.s3.assetBucket,
            props.storageResources.s3.assetVisualizerBucket,
            props.storageResources.sns.assetBucketObjectCreatedTopic,
            props.config,
            props.vpc,
            props.visualizerPipelineSubnets,
            props.storageResources.encryption.kmsKey
