...
export interface DynamoDbAuthDefaultsBasicConstructStackProps extends cdk.StackProps {
...
export class DynamoDbAuthDefaultsBasicConstructStack extends Construct {
    constructor(
        parent: Construct,
        name: string,
        props: DynamoDbAuthDefaultsBasicConstructStackProps
    ) {
        super(parent, name);

        const roleName = "basic";
        const roleNameIDClean = "basic";
        ...
        const awsSdkCallRoleBasic: AwsSdkCall = {
            ...
            parameters: {
                ...
                Item: {
                    ...
                    description: {
                        S: "Basic User - Read/Write access to all databases and assets. Read only access to pipelines, workflows, and metadata schemas.",
                    },
                    id: {
