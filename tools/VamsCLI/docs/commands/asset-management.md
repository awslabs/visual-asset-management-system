...
**Note:** Asset IDs are automatically generated by the system and cannot be specified through the CLI or web front-end. The generated asset ID will be returned in the response.
