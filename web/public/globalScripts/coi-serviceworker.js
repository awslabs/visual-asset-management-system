        ...
        event.respondWith(
            fetch(request)
                .then((response) => {
                    ...
                    // Log header injection for main document and important resources
                    if (r.mode === "navigate" || r.destination === "document" || r.url.includes("index.html")) {
                        console.log("[COI Service Worker] Headers set for:", r.url);
