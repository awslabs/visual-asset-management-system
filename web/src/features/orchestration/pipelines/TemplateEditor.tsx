...
const TemplateEditor: React.FC<TemplateEditorProps> = ({ databaseId, pipelineId }) => {
    ...
    const canEdit = can("PUT", "/database/{databaseId}/pipelines/{pipelineId}/templates/{templateId}");
    const canArchive = can("DELETE", "/database/{databaseId}/pipelines/{pipelineId}/templates/{templateId}");
