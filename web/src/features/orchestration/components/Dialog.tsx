    ...
    return (
        <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
            <RadixDialog.Portal>
                ...
                <RadixDialog.Content className="orchestration-root fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface-container rounded-lg shadow-xl max-w-2xl w-full max-h-[85vh] overflow-auto z-50 p-6">
