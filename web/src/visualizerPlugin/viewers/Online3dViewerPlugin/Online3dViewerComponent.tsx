...
const Online3dViewerComponent: React.FC<ViewerPluginProps> = ({
    assetId,
    databaseId,
    assetKey,
    multiFileKeys,
    ...
    useEffect(() => {
        ...
        const loadMultipleAssets = async () => {
            try {
                ...
                if (urls.length > 0 && engineElement.current) {
    ...
    }, [loaded, assetKey, multiFileKeys, assetId, databaseId, versionId]);
