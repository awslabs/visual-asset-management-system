            ...
            try {
                ...
                if (viewer.GetMeshIntersectionUnderMouse) {
                    try {
                        ...
                        } else if (window.OV && window.OV.IntersectionMode && window.OV.IntersectionMode.MeshOnly !== undefined) {
                            intersectionMode = window.OV.IntersectionMode.MeshOnly;
                        }
                        
                        intersection = viewer.GetMeshIntersectionUnderMouse(intersectionMode, mouseCoordinates);
                        console.log("Intersection found using GetMeshIntersectionUnderMouse with mode:", intersectionMode);
                    } catch (error) {
