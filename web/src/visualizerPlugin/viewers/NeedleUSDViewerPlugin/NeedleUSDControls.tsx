...
interface NeedleUSDControlsProps {
    scene: any;
    camera: any;
    renderer: any;
    usdRoot: any;
...
const NeedleUSDControls: React.FC<NeedleUSDControlsProps> = ({
    scene,
    camera,
    renderer,
    usdRoot,
    ...
    const setCameraView = useCallback(
        (view: string) => {
            if (!camera || !usdRoot || !controls) return;
...
export default NeedleUSDControls;
