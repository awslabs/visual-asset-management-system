...
import NeedleUSDMaterialEditor from "./NeedleUSDMaterialEditor";

export interface MaterialLibraryItem {
    id: string;
    name: string;
    material: any; // THREE.Material
    usedBy: Set<string>; // Object UUIDs
    isCustom: boolean;
    originalMaterial?: any; // For reset functionality
}

interface NeedleUSDMaterialLibraryProps {
...
const NeedleUSDMaterialLibrary: React.FC<NeedleUSDMaterialLibraryProps> = ({
    materialLibrary,
    selectedMaterialId,
    onSelectMaterial,
    onCreateMaterial,
...
export default NeedleUSDMaterialLibrary;
