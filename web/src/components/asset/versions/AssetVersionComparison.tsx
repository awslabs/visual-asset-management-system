...
const getStatusIcon = (status: string) => {
    switch (status) {
        case "added":
            return <span style={{ color: "var(--vams-color-success)", marginRight: "4px" }}>➕</span>;
        case "removed":
        ...
        case "unchanged":
            return <span style={{ color: "var(--vams-text-secondary)", marginRight: "4px" }}>✓</span>;
        default:
            return null;
    }
};
                        ...
                        <div>
                            <SpaceBetween direction="vertical" size="s">
                                ...
                                {comparison.summary && (
                                    <>
                                        <div>
                                            <span style={{ color: "var(--vams-color-success)", marginRight: "4px" }}>
                                                ➕
                                            </span>
                                            <strong>Added:</strong> {comparison.summary.added}
                                        </div>
                                        <div>
                                            <span style={{ color: "var(--vams-color-error)", marginRight: "4px" }}>
                                                ➖
                                            </span>
                                            <strong>Removed:</strong> {comparison.summary.removed}
                                        </div>
                                        <div>
                                            <span style={{ color: "var(--vams-color-info)", marginRight: "4px" }}>
                                                ✏️
                                            </span>
                                            <strong>Modified:</strong> {comparison.summary.modified}
                                        </div>
                                        <div>
                                            <span style={{ color: "var(--vams-text-secondary)", marginRight: "4px" }}>
                                                ✓
                                            </span>
...
export const EnhancedAssetVersionComparison: React.FC<EnhancedComparisonProps> = ({ onClose }) => {
    ...
    const metadataColumns = [
        ...
        },
        {
            ...
            header: "Value Type",
            cell: (item: MetadataComparison) => (
                <div style={{ fontSize: "0.9em", color: "var(--vams-text-secondary)" }}>{item.valueType || "N/A"}</div>
            ),
        },
    ];
