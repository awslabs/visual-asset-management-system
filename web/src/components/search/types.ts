...
export const DEFAULT_PREFERENCES: SearchPreferences = {
    viewMode: 'table',
    assetTableColumns: ['str_assetname', 'str_databaseid', 'str_assettype', 'str_description', 'str_asset_version_id', 'list_tags', 'metadata'],
    fileTableColumns: ['str_key', 'str_assetname', 'str_databaseid', 'str_fileext', 'num_filesize', 'date_lastmodified', 'list_tags', 'metadata'],
    cardSize: 'medium',
