    ...
    return (
        <SpaceBetween direction="horizontal" size="xs">
            <FormField
                label="W"
                errorText={
                    error && wxyzValues.w !== "" && !isValidNumber(wxyzValues.w)
                        ? "Invalid number"
                        : undefined
                }
            >
            ...
            <FormField
                label="X"
                errorText={
                    error && wxyzValues.x !== "" && !isValidNumber(wxyzValues.x)
                        ? "Invalid number"
                        : undefined
                }
            >
            ...
            <FormField
                label="Y"
                errorText={
                    error && wxyzValues.y !== "" && !isValidNumber(wxyzValues.y)
                        ? "Invalid number"
                        : undefined
                }
            >
            ...
            <FormField
                label="Z"
                errorText={
                    error && wxyzValues.z !== "" && !isValidNumber(wxyzValues.z)
                        ? "Invalid number"
                        : undefined
                }
            >
