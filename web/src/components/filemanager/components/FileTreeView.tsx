...
import { TreeItemProps, SearchResultsProps, DirectoryTreeProps, FileManagerContextType } from "../types/FileManagerTypes";
import "./FileTreeView.css";

// Create a context that will be overridden by the main component
export const FileManagerContext = React.createContext<FileManagerContextType | undefined>(undefined);
...
function TreeItem({ item }: TreeItemProps) {
    ...
    const isMultiSelected = state.selectedItems.some(selectedItem => selectedItem.relativePath === item.relativePath);
