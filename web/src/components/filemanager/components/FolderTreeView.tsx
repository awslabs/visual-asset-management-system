...
function FolderTreeItem({ 
    ...
    const hasSubfolders = item.subTree.some(child => {
        const childIsFolder = child.isFolder !== undefined ? child.isFolder : (child.subTree.length > 0 || child.keyPrefix.endsWith('/'));
    ...
    return (
        <div className="folder-tree-item">
            ...
            >
                {hasSubfolders && (
                    <span 
                        className="folder-tree-item-caret"
                ...
                {!hasSubfolders && (
                    <span className="folder-tree-item-spacer" />
                )}
                ...
                <span className="folder-tree-item-name">
                    {item.displayName}
                </span>
            </div>
