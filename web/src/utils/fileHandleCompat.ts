        ...
        return {
            ...
            getFile: async () => {
                try {
                    ...
                    throw new Error(
                        "Failed to get file from handle. Browser may not fully support the File System Access API."
                    );
                }
            },
            isDirectory: false,
        ...
        return {
            ...
            getFile: async () => {
                try {
                    ...
                    throw new Error(
                        "Failed to get file from handle. The file may not be accessible."
                    );
                }
            },
            isDirectory: false,
...
export const safeGetFile = async (handle: any): Promise<File> => {
    try {
        ...
        throw new Error(
            "Failed to get file from handle. The browser may not support this operation."
        );
    }
};
