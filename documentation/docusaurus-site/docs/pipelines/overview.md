...
| [Coordinate Transform](coordinate-transform.md)       | `useConversionCoordinateTransform`       | Reproject point clouds between CRS with per-asset metadata overrides                                                                                                               | E57, LAS, LAZ, PLY                                                                                      | AWS Batch (Fargate) | Yes          |
