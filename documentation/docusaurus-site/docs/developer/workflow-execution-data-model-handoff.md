...
| Table                                           | PK                  | SK                                   | Indexes                                                                                                                                                                                                                                                                                  |
| ----------------------------------------------- | ------------------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| WorkflowExecutionsStorageTableV2                | executionId (GUID)  | workflowDatabaseId:workflowId        | GSI WorkflowExecutionsByWorkflowGSI (PK workflowDatabaseId:workflowId, SK executionStartDate); GSI WorkflowExecutionsByGroupGSI (PK executionGroupId, SK executionStartDate); GSI WorkflowExecutionsByDateGSI (PK globalListPartition, SK executionStartDate — global newest-first list) |
