...
| GenAI CAD STEP Agent                    | `useGenAiCadStepAgent`                            | Create or modify CAD STEP files from a prompt with a Strands agent on Amazon Bedrock AgentCore or AWS Batch              | Disabled |
