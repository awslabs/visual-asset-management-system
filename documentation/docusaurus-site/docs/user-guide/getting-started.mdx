...
Watch the full demo walkthrough to see VAMS in action — asset management, 3D visualization, search, pipelines, and more.

<video
    controls
    width="100%"
    style={{ aspectRatio: "16/9" }}
    src={useBaseUrl("/mp4/vams-20260420-demoReel.mp4")}
></video>
...
| **Assets and Files** | Browse the asset list, and search by keyword or natural language across all databases. |
...
| **Executions**  | Monitor workflow executions across every workflow, and open a run to see its detail. |
