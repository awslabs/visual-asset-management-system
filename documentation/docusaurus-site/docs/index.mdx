...
<video
    ...
    src={useBaseUrl("/mp4/vams-20260420-demoReel-short.mp4")}
></video>
...
_VAMS deploys as a serverless architecture on AWS, supporting commercial, GovCloud (US), and European Sovereign Cloud regions._
...
| **Interactive visualization**   | View assets directly in the browser with 20 built-in viewer plugins for 3D, point cloud, CAD, media, and document formats                                |
| **Automated processing**        | Transform assets using configurable pipelines backed by AWS Lambda, Amazon SQS, Amazon EventBridge, or AWS Deadline Cloud                                |
...
| **Search and discovery**        | Full-text and metadata search powered by Amazon OpenSearch, natural-language search powered by Amazon Bedrock embeddings, and map-based geographic views |
