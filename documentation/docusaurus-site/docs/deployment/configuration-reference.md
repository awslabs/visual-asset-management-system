...
:::note[Implemented by]
Nested stack: `infra/lib/nestedStacks/pipelines/conversion/meshCadMetadataExtraction/conversionMeshCadMetadataExtractionBuilder-nestedStack.ts` (`ConversionMeshCadMetadataExtractionNestedStack`) — a containerized AWS Lambda function.
:::
...
| `app.pipelines.useSystemGenAiMetadata.bedrockGuardrail.guardrailIdentifier` | string  | `""`                                                                                                                                                                    | Identifier of an operator-owned Amazon Bedrock guardrail. When set, every analysis prompt is sent with this guardrail and the untrusted prompt sections (file text, existing metadata, descriptions) are tagged for its prompt-attack input filter; the pipeline never creates a guardrail. Set together with `guardrailVersion`, or leave both empty. Configuration validation rejects one without the other.                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `app.pipelines.useSystemGenAiMetadata.bedrockGuardrail.guardrailVersion`    | string  | `""`                                                                                                                                                                    | Version of the guardrail (`1`, `2`, … or `DRAFT`). Set together with `guardrailIdentifier`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
:::note[Implemented by]
Nested stack: `infra/lib/nestedStacks/pipelines/genAi/metadata3dLabeling/metadata3dLabelingBuilder-nestedStack.ts` (`Metadata3dLabelingNestedStack`) — AWS Batch on Fargate with Amazon Bedrock inference.
:::

| Field                                                                          | Type    | Default                   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------ | ------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `app.pipelines.useGenAiMetadata3dLabeling.enabled`                             | boolean | `false`                   | Enables the GenAI metadata labeling pipeline.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `app.pipelines.useGenAiMetadata3dLabeling.bedrockModelId`                      | string  | _(required when enabled)_ | Amazon Bedrock model ID for inference (for example, `global.anthropic.claude-sonnet-4-5-20250929-v1:0`). A cross-Region inference-profile prefix is partition-specific: `global.` and `us.` exist in the commercial partition, and AWS GovCloud (US) uses `us-gov.`. Configuration validation rejects a commercial prefix outside the commercial partition, and the GovCloud and EU Sovereign Cloud templates leave the value empty for the operator to set from the models offered in their partition. |
