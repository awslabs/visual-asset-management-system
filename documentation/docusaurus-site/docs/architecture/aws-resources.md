...
| WorkflowTriggersStorageTable              | `workflowDatabaseId:workflowId` | `triggerType`                              | `TriggersByTypeGSI` (PK: triggerType, SK: workflowDatabaseId:workflowId)                                                                                                                       | Workflow triggers (e.g. file upload)        |
| WorkflowExecutionOutputsIndexStorageTable | `databaseId:assetId`            | `workflowExecutionId`                      | `OutputsByExecutionGSI` (PK: workflowExecutionId, SK: databaseId:assetId)                                                                                                                      | "Executions that wrote to this asset" index |
...
| WorkflowExecutionConfigurationStorageTable      | `workflowExecutionId` | `recordType`                           | --                                                                                                                                                                                                                                                                 | Workflow-level execution configuration |
