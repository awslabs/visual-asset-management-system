...
| ------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [2.6.0](#260) | 2026-05-08 | Physna Sync add-on (Phase 1): one-way synchronization of supported VAMS files and metadata to a Physna tenant; geospatial search and map view across assets and files (new `geo_MD_location` field); OpenSearch index v3 + provisioned engine upgrade to 3.5; next-generation OpenSearch Serverless upgrade (scale-to-zero, higher performance, better cost pricing); advanced IAM role customization for restricted environments |
