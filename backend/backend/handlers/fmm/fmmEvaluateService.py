...
from handlers.fmm.fmmComplianceTrigger import check_and_trigger_cascade
...
logger = safeLogger(service_name="FMMEvaluateService")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        logger.exception("Unhandled error in FMM Evaluate Service")
