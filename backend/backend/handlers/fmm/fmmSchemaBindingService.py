"""FMM Schema Binding Service handler.
...
logger = safeLogger(service_name="FMMSchemaBindingService")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        logger.exception("Unhandled error in FMM Schema Binding Service")
