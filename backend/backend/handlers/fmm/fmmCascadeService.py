...
logger = safeLogger(service_name="FMMCascadeService")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        logger.exception("Unhandled error in FMM Cascade Service")
...
def approve_cascade(cascade_id, body):
    ...
    from handlers.fmm.fmmCascadeExecutor import execute_cascade
