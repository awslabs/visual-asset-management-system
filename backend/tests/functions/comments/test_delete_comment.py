...
def test_delete_comment(comments_table, delete_event):
    ...
    response = commentService.delete_comment(
        asset_id, asset_version_id_and_comment_id, delete_event
    )
...
def test_delete_comment_not_exist(comments_table, delete_event):
    """
