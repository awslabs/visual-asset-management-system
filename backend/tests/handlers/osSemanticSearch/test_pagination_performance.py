...
# from handlers.osSemanticSearch.search import lambda_handler, DatabaseAccessManager, QueryBuilder, ResponseProcessor
...
class TestDatabaseAccessPagination:
    ...
    def test_database_scan_with_progress_logging(self, mock_environment, mock_claims_and_roles):
        ...
        with patch('handlers.osSemanticSearch.search.dynamodb_client') as mock_client:
            with patch('handlers.osSemanticSearch.search.logger') as mock_logger:
