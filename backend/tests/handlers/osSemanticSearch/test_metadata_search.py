...
# from handlers.osSemanticSearch.search import lambda_handler, FieldClassifier, QueryBuilder, ResponseProcessor
    ...
    def test_metadata_search_request(self, mock_environment, mock_claims_and_roles, mock_opensearch_response):
        ...
        with patch('handlers.osSemanticSearch.search.request_to_claims') as mock_claims:
            ...
            with patch('handlers.osSemanticSearch.search.CasbinEnforcer') as mock_enforcer:
                ...
                with patch('handlers.osSemanticSearch.search.SearchManager') as mock_search_manager:
                    ...
                    with patch('handlers.osSemanticSearch.search.DatabaseAccessManager.get_accessible_databases') as mock_db_access:
        ...
        with patch('handlers.osSemanticSearch.search.request_to_claims') as mock_claims:
            ...
            with patch('handlers.osSemanticSearch.search.CasbinEnforcer') as mock_enforcer:
                ...
                with patch('handlers.osSemanticSearch.search.SearchManager') as mock_search_manager:
                    ...
                    with patch('handlers.osSemanticSearch.search.QueryBuilder') as mock_query_builder:
...
class TestSearchExplanation:
    ...
    def test_add_search_explanation(self, mock_opensearch_response):
        ...
        from handlers.osSemanticSearch.search import DatabaseAccessManager, ResponseProcessor
