...
def test_add_comment(comments_table, add_valid_event):
    """
    ...
    assetVersionIdAndCommentId = add_valid_event["pathParameters"][
...
def test_add_comment_invalid(comments_table, add_invalid_event):
    """
    Testing the add comment lambda handler with valid data
    :param comments_table: mocked dynamoDB commentStorageTable
