...
@pytest.mark.unit
class TestFMMQuarantineService:
    @patch("backend.backend.handlers.fmm.fmmQuarantineService.compliance_table")
    @patch("backend.backend.handlers.fmm.fmmQuarantineService.request_to_claims")
    def test_list_quarantined(self, mock_claims, mock_table):
        ...
        from backend.backend.handlers.fmm.fmmQuarantineService import lambda_handler
    ...
    @patch("backend.backend.handlers.fmm.fmmQuarantineService.audit_table")
    @patch("backend.backend.handlers.fmm.fmmQuarantineService.compliance_table")
    @patch("backend.backend.handlers.fmm.fmmQuarantineService.request_to_claims")
