...
@pytest.mark.unit
class TestFMMEvaluateService:
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.compliance_table")
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.request_to_claims")
    def test_get_compliance_state_found(self, mock_claims, mock_table):
        ...
        from backend.backend.handlers.fmm.fmmEvaluateService import lambda_handler
    ...
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.audit_table")
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.compliance_table")
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.asset_table")
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.evaluation_table")
    @patch("backend.backend.handlers.fmm.fmmEvaluateService.request_to_claims")
