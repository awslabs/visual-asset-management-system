...
@pytest.mark.unit
class TestFMMSchemaService:
    @patch("backend.backend.handlers.fmm.fmmSchemaService.schema_table")
    @patch("backend.backend.handlers.fmm.fmmSchemaService.request_to_claims")
    def test_list_schemas(self, mock_claims, mock_table):
        ...
        from backend.backend.handlers.fmm.fmmSchemaService import lambda_handler
