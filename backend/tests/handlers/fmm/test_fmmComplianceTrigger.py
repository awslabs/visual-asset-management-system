...
class TestCheckAndTriggerCascade:
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.audit_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.cascade_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.asset_links_table")
    def test_creates_cascade_when_children_exist(
        ...
        from backend.backend.handlers.fmm.fmmComplianceTrigger import (
...
class TestProcessAssetEvent:
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.compliance_table")
    ...
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.database_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.compliance_table")
    ...
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.audit_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.evaluation_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.schema_table")
    @patch("backend.backend.handlers.fmm.fmmComplianceTrigger.compliance_table")
