...
@pytest.mark.unit
class TestComplianceCascadeService:
    @patch("backend.backend.handlers.compliance.complianceCascadeService.cascade_table")
    @patch("backend.backend.handlers.compliance.complianceCascadeService.request_to_claims")
    def test_list_pending_cascades(self, mock_claims, mock_table):
        ...
        from backend.backend.handlers.compliance.complianceCascadeService import lambda_handler
    ...
    @patch("backend.backend.handlers.compliance.complianceCascadeService.audit_table")
    @patch("backend.backend.handlers.compliance.complianceCascadeService.cascade_table")
    @patch("backend.backend.handlers.compliance.complianceCascadeService.request_to_claims")
