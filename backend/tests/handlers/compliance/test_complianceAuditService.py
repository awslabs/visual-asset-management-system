...
class TestComplianceAuditService:
    @patch("backend.backend.handlers.compliance.complianceAuditService.audit_table")
    @patch("backend.backend.handlers.compliance.complianceAuditService.request_to_claims")
    def test_query_audit_no_filter(self, mock_claims, mock_table):
        ...
        from backend.backend.handlers.compliance.complianceAuditService import lambda_handler
